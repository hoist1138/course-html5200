...
imageList.push("images/drawing/thumbs/artwork_1.jpg");

//lets selectively remove any element we want...
//we can also assign the spliced image to a variable for use
var mySplice = imageList.splice(0, 3);
console.log(mySplice);

//remove the last item in an array
var lastImage = imageList.pop();
//console.log(lastImage);

//update an element in the array list
